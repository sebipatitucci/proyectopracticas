...
?>
    ...
    <?php
        ...
        if (
            ...
            SET idAccidente = '$opciones', latitud = '$latitud', longitud = '$longitud', fecha = '$fecha', hora = '$hora', descripcion = '$descripcion'
            where idEventos = '$id2'";
            ...
            if ($resultado) {
                echo "<div class='ok animate__animated animate__fadeInLeft'>¡LA DENUNCIA SE HA MODIFICADO!</div>";
                echo "<a href='mis-denuncias.php'>Volver a mis denuncias</a>";
            } else {
