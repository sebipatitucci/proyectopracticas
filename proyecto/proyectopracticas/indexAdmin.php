        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <p>Trabajamos en estrecha colaboración con las autoridades y organismos competentes para garantizar
                    que cada denuncia se gestione de manera eficiente y adecuada.</p>
                </div>
                <div class="col-6">
                    <img src="IMAGENES/Datos.png" alt="">
                    <h3>Fácil de usar</h3>
                    <p>¿Listo para hacer oír tu voz? Nuestro proceso de denuncia es simple y efectivo.
                    Completa nuestro formulario de denuncia, adjunta cualquier evidencia relevante y
                     deja que nosotros nos encarguemos del resto.</p>
                </div>
            </div>
        </div>
